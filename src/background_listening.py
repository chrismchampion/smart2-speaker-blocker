...
def callback(recognizer, audio):
    ...
    try:
        ...
        print("Sphinx Speech Recognition thinks you said " + recognizer.recognize_sphinx(audio))
...
while True:
    time.sleep(0.1)
# we're not listening anymore, even though the background thread might still be running for a second or two while
